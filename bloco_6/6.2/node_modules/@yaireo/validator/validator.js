...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            invalid         : 'a entrada não é conforme o esperado',
            short           : 'a entrada é muito curta',
            long            : 'a entrada é muito longa',
            checked         : 'deve ser verificado',
            empty           : 'por favor, coloque algo aqui',
            select          : 'Por favor selecione uma opção',
            number_min      : 'muito baixo',
            number_max      : 'muito alto',
            url             : 'URL inválido',
            number          : 'não é um número',
            email           : 'endereço de e-mail é inválido',
            email_repeat    : 'e-mails não correspondem',
            date            : 'data inválida',
            time            : 'hora inválida',
            password_repeat : 'senhas não correspondem',
            no_match        : 'em correspondência',
